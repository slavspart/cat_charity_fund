...
from app.schemas.donation import DonationCreate, DonationDB_long, DonationDB_short
...
@router.get(
    "/my",
    response_model=List[DonationDB_short],
)
async def get_my_donations(
    ...
    donations = await donation_crud.get_by_user(Donation, session, user)
    return donations
